...
import AccountSquares from "../../../UserTypes/OrdinaryUser/Pages/Extras/Components/AccountSquares";
import LogoutModal from "../../../UserTypes/OrdinaryUser/Pages/Notifications-and-settings/LogoutModal";
import { logoutUs } from "../../../Redux/Auth/Auth";
import AsyncStorage from "@react-native-async-storage/async-storage";
import { useDispatch, useSelector } from "react-redux";
import { deleteUser } from "../../../Redux/Users/Users";

const LogOutLogisticsUser = (props) => {
  ...
  //console.log(user.logisticUserId, "psll");
  const logisticUserId = user?.logisticUserId;
  ...
  const handleDelete = async () => {
    dispatch(deleteUser(logisticUserId))
      .then((response) => {
...
export default LogOutLogisticsUser;
