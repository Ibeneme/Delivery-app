...
import { OrdinaryUserPaymentHistory } from "../../../../Redux/Payment/Payments";
...
const PaymentHistory = () => {
  ...
  useEffect(() => {
    setLoading(true);
    dispatch(OrdinaryUserPaymentHistory(ordinaryUserId))
      .then((response) => {
        setLoading(false);
        console.log(response?.payload?.data?.payments, "responseresponse");
      })
      .catch((error) => {});
  }, []);
